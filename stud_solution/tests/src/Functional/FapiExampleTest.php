...
/**
 * Ensure that the stud_solution forms work properly.
 *
 * @group stud_solution
 * @group examples
 *
...
class FapiExampleTest extends ExamplesBrowserTestBase {
  ...
  public function doTestRoutes() {
    ...
    $routes = [
      ...
      'stud_solution.simple_form' => ['Submit'],
      'stud_solution.input_demo' => ['Submit'],
      'stud_solution.state_demo' => ['Submit'],
      'stud_solution.container_demo' => ['Submit'],
      'stud_solution.vertical_tabs_demo' => ['Submit'],
      // Modal form has a submit button, but requires input.
      'stud_solution.modal_form' => [],
      'stud_solution.ajax_color_demo' => ['Submit'],
      'stud_solution.build_demo' => ['Submit'],
      'stud_solution.ajax_addmore' => ['Submit'],
      // Multistep form has submit buttons, but requires input.
      'stud_solution.multistep_form' => [],
    ];
  ...
  public function doTestAjaxColorForm() {
    ...
    $this->drupalPostForm(Url::fromRoute('stud_solution.ajax_color_demo'), $edit, 'Submit');
  ...
  public function doTestBuildDemo() {
    $assert = $this->assertSession();
    $build_demo_url = Url::fromRoute('stud_solution.build_demo');
  ...
  public function doTestContainerDemoForm() {
    ...
    $this->drupalPostForm(Url::fromRoute('stud_solution.container_demo'), $edit, 'Submit');
  ...
  public function doTestInputDemoForm() {
    ...
    $this->drupalPostForm(Url::fromRoute('stud_solution.input_demo'), $edit, 'Submit');
    $assert->statusCodeEquals(200);
  ...
  public function doTestModalForm() {
    ...
    $this->drupalPostForm(Url::fromRoute('stud_solution.modal_form'), $edit, 'Submit');
    $assert->pageTextContains('Submit handler: You specified a title of My Book.');
  }

  /**
   * Check routes defined by stud_solution.
   */
  public function doTestSimpleFormExample() {
    ...
    $this->drupalPostForm(Url::fromRoute('stud_solution.simple_form'), $edit, 'Submit');
  ...
  public function doTestStateDemoForm() {
    ...
    $this->drupalPostForm(Url::fromRoute('stud_solution.state_demo'), $edit, 'Submit');
  ...
  public function doTestAjaxAddMore() {
    ...
    $ajax_addmore_url = Url::fromRoute('stud_solution.ajax_addmore');
